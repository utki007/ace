...
async def on_ready():
	...
	bot.role_dict = {
		...
		"26": guild.get_role(810134737829888050),
	...
	bot.event_10k = {
		"100": guild.get_role(940581045038899230),
		"101": guild.get_role(942719030752583680),
	...
	bot.premium_colour_users = [
		...
		guild.get_role(1200396603698192425)
	]
...
if __name__ == "__main__":
	...
	bot.bl = Document(bot.db, "blacklistServers")
