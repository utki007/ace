...
class dankHeist(commands.Cog,name="Dank Heist", description="Heist Manager"):
    ...
    async def rr(self, ctx, *,Title: str = "Some important self roles"):
        ...
        nopartnership = discord.utils.get(guild.roles, id=810593886720098304)
        
        # l = [heist,danker,partnerHeist,giveaway,partnership]
        
        rr = discord.Embed(
                title=f"    **{Title}**   ",
                description= f"<a:heisttime:932911351154741308> {self.bot.emojis_list['right']} {heist.mention}\n"
                            f"<a:heist:925617827447177247> {self.bot.emojis_list['right']} {partnerHeist.mention}\n"
        ...
        await message.add_reaction("<a:heisttime:932911351154741308>")
        ...
        await message.add_reaction("<a:nopartnership:929440715539374171>")
