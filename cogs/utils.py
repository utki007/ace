...
class utils(commands.Cog):
    ...
    async def dankdown(self, ctx):
        ...
        async with ctx.typing():
            ...
            lv3 = discord.utils.get(ctx.guild.roles, id=811307500321505320)
            ...
            override_dank_2 = dank_2.overwrites_for(default_role)
            ...
            dlock = discord.Embed(
                ...
                description=f":lock: Dank Memer is offline. Keep an eye out on `bot-updates`. Ping or DM a Moderator if you notice the bot is back and this channel is still locked. \n",
                color=0xff0000,
    ...
    async def dankup(self, ctx):
        ...
        async with ctx.typing():
            ...
            dunlock = discord.Embed(
                title=f"    **{'Dank Memer is back online.'}**   ",
                description=f":unlock: Dank Memer is back. Have a Good Day!!! \n",
                color=0x78AB46,
                timestamp=datetime.datetime.utcnow()
            )
            dunlock.set_footer(
